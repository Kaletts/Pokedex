...
let pokemonImage = document.getElementById('pokemonImage'); //Selecciono la pokeball
pokemonImage.classList.add('pokeBallAnimated'); //Le agrego la clase par aanimarla
